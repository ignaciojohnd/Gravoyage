...
import BirdController, { BirdStates } from "./BirdController";

export default abstract class BirdState extends State {
	owner: GameNode;
	gravity: number = 500;
	parent: BirdController;
	...
	/**
	 * Here is where the states are defined for handling enemy gravity effects. We recieve a player suit change event 
	 * and adjust the enemy gravity effects accordingly based on its color
	 */
