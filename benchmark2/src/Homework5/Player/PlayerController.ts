...
export default class PlayerController extends StateMachineAI {
    ...
    update(deltaT: number): void {
        ...
        //CHANGE THIS TO BE IF TOUCHED A SPIKE TILE
        if(this.tilemap.getTileAtWorldPosition(new Vec2(this.owner.position.x,this.owner.position.y + 17)) === 9){
            this.emitter.fireEvent(HW5_Events.LEVEL_END);
        }
        else if(this.tilemap.getTileAtWorldPosition(new Vec2(this.owner.position.x+ 17,this.owner.position.y)) === 9){
            this.emitter.fireEvent(HW5_Events.LEVEL_END);
        }
